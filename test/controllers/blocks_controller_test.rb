...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { body: @block.body, origin: @block.origin, title: @block.title } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { body: @block.body, origin: @block.origin, title: @block.title } }
